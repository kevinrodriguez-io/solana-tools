...
export const RoundButton: FC<JSX.IntrinsicElements['button']> = ({
  ...
  return (
    ...
    //   </button>
    <button
      className={cx("inline-flex items-center p-2 border border-transparent rounded-full shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500", className)}
      {...props}
    >
      {children}
    </button>
